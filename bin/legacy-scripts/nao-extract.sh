...
if [[ "$FLAG_UPLOAD" = 1 ]]; then
    ...
    RSYNC_CONCISE "$RUNSWIFT_CHECKOUT_DIR/logs/$DATE/" "repository@runswift2.cse.unsw.edu.au:/home/repository/logs/$FLAG_UPLOAD_DIR/"
    RSYNC_CONCISE "$RUNSWIFT_CHECKOUT_DIR/test/audio/$DATE/" "repository@runswift2.cse.unsw.edu.au:/home/repository/logs/$FLAG_UPLOAD_DIR/"
fi
