...
void populate_options(po::options_description &config_file_options) {
   ...
   debug_config.add_options()
      ...
      ("debug.logpath",
      po::value<string>()->default_value("/home/nao/logs"),
      ...
      ("debug.act_on_ref_hands_raised", po::value<bool>()->default_value(true),
       "Go to READY state when in STANDBY state and referee hands raised is seen")
      ...
      ("debug.dump_overwrite,D", po::value<bool>()->default_value(false),
      "Overwrite dump file if it exists, false by default.")
   ...
   behaviour_config.add_options()
      ...
      ("behaviour.headskill,w",
      po::value<string>()->default_value("MainHeadSkill"),
      ...
      ("behaviour.walk_speed", po::value<float>()->default_value(1.0),
      "Speed of walk between slowest stable (0) and maximum (1)")
      ("behaviour.dribble_speed", po::value<float>()->default_value(0.5),
      "Speed of dribble between slowest stable (0) and maximum (1) where 0.5 is typical due to foot lift height and toes")
   ...
   vision_config.add_options()
      ...
      ("vision.top.refereehands.handminhdistance", po::value<int>()->default_value(0),
      "Referee hands: minimum horizontal distance between hands")
      ("vision.top.refereehands.handmaxhdistance", po::value<int>()->default_value(200),
      "Referee hands: maximum horizontal distance between hands")
      ("vision.top.refereehands.handminvdistance", po::value<int>()->default_value(0),
      "Referee hands: minimum vertical distance between hands")
      ("vision.top.refereehands.handmaxvdistance", po::value<int>()->default_value(100),
      "Referee hands: maximum vertical distance between hands")
      ("vision.top.refereehands.cropleft", po::value<int>()->default_value(0),
      "Referee hands: crop detection region from left")
      ("vision.top.refereehands.cropright", po::value<int>()->default_value(0),
      "Referee hands: crop detection region from right")
      ("vision.top.refereehands.croptop", po::value<int>()->default_value(0),
      "Referee hands: crop detection region from top")
      ("vision.top.refereehands.cropbottom", po::value<int>()->default_value(620),
      "Referee hands: crop detection region from bottom")
      ("vision.top.refereehands.enabled", po::value<int>()->default_value(1),
      "Referee hands: 0 = turned off, 1 = available")
      ("vision.top.refereehands.area", po::value<int>()->default_value(50),
      "Referee hands: min area to consider")
      ;
