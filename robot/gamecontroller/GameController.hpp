...
class GameController : Adapter {
    ...
    private:
        ...
        /**
         * Return True if a ready signal was detected
         */
        bool refereeSeen();

        /* Flag to turn off acting on referee hands raised if a player in a game should not risk the penalty */
        bool actOnRefHandsRaised;
        ...
        /**
         * Transmit our current state to game controller
         */
      ...
      boost::asio::ip::udp::socket gcSocket;
};
