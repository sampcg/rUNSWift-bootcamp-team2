...
static inline ButtonPresses doButtons(
   ...
   static int head_buttons_count = 0, calibrate_buttons_count = 0, challenge_buttons_count = 0;
   ...
   //            kill -9 me in case i don't die
               system("/usr/bin/pkill runswift & (sleep " KILL_SLEEP_SECONDS "; /usr/bin/pkill -9 runswift) &");
            }
         }
