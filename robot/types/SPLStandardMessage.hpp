...
// we are only allowed to send 128 bytes in 2023/2024
static_assert(sizeof(SPLStandardMessage) == 128);
// ensure broadcast data stays in or below our SPL buffer
static_assert(sizeof(BroadcastData) <= SPL_STANDARD_MESSAGE_DATA_SIZE);
