...
void BehaviourBlackboard::readOptions(const program_options::variables_map& config) {
    ...
    walkSpeed = config["behaviour.walk_speed"].as<float>();
    dribbleSpeed = config["behaviour.dribble_speed"].as<float>();
...
VisionBlackboard::VisionBlackboard() {
   ...
   redRegions.reserve(MAX_RED_REGIONS);
   refereeHands.reserve(MAX_RED_REGIONS);
...
void VisionBlackboard::readOptions(const program_options::variables_map& config) {
   ...
   refereeHandDetectorSettings.handMinHDistance = config["vision.top.refereehands.handminhdistance"].as<int>();
   refereeHandDetectorSettings.handMaxHDistance = config["vision.top.refereehands.handmaxhdistance"].as<int>();
   refereeHandDetectorSettings.handMinVDistance = config["vision.top.refereehands.handminvdistance"].as<int>();
   refereeHandDetectorSettings.handMaxVDistance = config["vision.top.refereehands.handmaxvdistance"].as<int>();
   refereeHandDetectorSettings.cropLeft = config["vision.top.refereehands.cropleft"].as<int>();
   refereeHandDetectorSettings.cropRight = config["vision.top.refereehands.cropright"].as<int>();
   refereeHandDetectorSettings.cropTop = config["vision.top.refereehands.croptop"].as<int>();
   refereeHandDetectorSettings.cropBottom = config["vision.top.refereehands.cropbottom"].as<int>();
   refereeHandDetectorSettings.enabled = config["vision.top.refereehands.enabled"].as<int>();
   refereeHandDetectorSettings.area = config["vision.top.refereehands.area"].as<int>();

   refereeHandDetectorParams.maskTopStartH = 0;
   refereeHandDetectorParams.maskTopStartS = 120;
   refereeHandDetectorParams.maskTopStartV = 50;
   refereeHandDetectorParams.maskTopEndH = 18;
   refereeHandDetectorParams.maskTopEndS = 255;
   refereeHandDetectorParams.maskTopEndV = 255;

   refereeHandDetectorParams.maskBottomStartH = 170;
   refereeHandDetectorParams.maskBottomStartS = 120;
   refereeHandDetectorParams.maskBottomStartV = 50;
   refereeHandDetectorParams.maskBottomEndH = 180;
   refereeHandDetectorParams.maskBottomEndS = 255;
   refereeHandDetectorParams.maskBottomEndV = 255;
