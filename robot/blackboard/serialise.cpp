...
static void serialise(const RefereeHandDetectorSettings &cpp, offnao::Vision_RefereeHandDetectorSettings &pb) {
   pb.set_handminhdistance(cpp.handMinHDistance);
   pb.set_handmaxhdistance(cpp.handMaxHDistance);
   pb.set_handminvdistance(cpp.handMinVDistance);
   pb.set_handmaxvdistance(cpp.handMaxVDistance);
   pb.set_cropleft(cpp.cropLeft);
   pb.set_cropright(cpp.cropRight);
   pb.set_croptop(cpp.cropTop);
   pb.set_cropbottom(cpp.cropBottom);
   pb.set_enabled(cpp.enabled);
   pb.set_area(cpp.area);
}

static void serialise(const RefereeHandDetectorParams &cpp, offnao::Vision_RefereeHandDetectorParams &pb) {
   pb.set_masktopstarth(cpp.maskTopStartH);
   pb.set_masktopstarts(cpp.maskTopStartS);
   pb.set_masktopstartv(cpp.maskTopStartV);
   pb.set_masktopendh(cpp.maskTopEndH);
   pb.set_masktopends(cpp.maskTopEndS);
   pb.set_masktopendv(cpp.maskTopEndV);
   pb.set_maskbottomstarth(cpp.maskBottomStartH);
   pb.set_maskbottomstarts(cpp.maskBottomStartS);
   pb.set_maskbottomstartv(cpp.maskBottomStartV);
   pb.set_maskbottomendh(cpp.maskBottomEndH);
   pb.set_maskbottomends(cpp.maskBottomEndS);
   pb.set_maskbottomendv(cpp.maskBottomEndV);
}
...
static void serialise(const RefereeHand &cpp, offnao::Vision_RefereeHand &pb) {
   serialise(cpp.topImageCoords, *pb.mutable_topimagecoords());
}

static void serialise(const RefereeHandsVisionInfo &cpp, offnao::Vision_RefereeHandsVisionInfo &pb) {
   serialise(cpp.left, *pb.mutable_left());
   serialise(cpp.right, *pb.mutable_right());
}
...
//     ::serialise(cpp.stateEstimation.robotPos, *pb.mutable_stateestimation()->mutable_robotpos());
      ...
      ::serialise(cpp.vision.redRegions, *pb.mutable_vision()->mutable_redregions());
      ::serialise(cpp.vision.refereeHands, *pb.mutable_vision()->mutable_refereehands());
      ::serialise(cpp.vision.refereeHandDetectorSettings, *pb.mutable_vision()->mutable_refereehanddetectorsettings());
      ::serialise(cpp.vision.cropRegion, *pb.mutable_vision()->mutable_cropregion());
      ::serialise(cpp.vision.refereeHandDetectorParams, *pb.mutable_vision()->mutable_refereehanddetectorparams());
...
void Blackboard::serialise(ostream &os) const {
   ...
   unsigned int size = bb.ByteSizeLong();
...
static void deserialise(RefereeHandDetectorSettings &cpp, const offnao::Vision_RefereeHandDetectorSettings &pb) {
   cpp.handMinHDistance      = pb.handminhdistance();         
   cpp.handMaxHDistance      = pb.handmaxhdistance();         
   cpp.handMinVDistance      = pb.handminvdistance();         
   cpp.handMaxVDistance      = pb.handmaxvdistance();         
   cpp.cropLeft              = pb.cropleft(); 
   cpp.cropRight             = pb.cropright();  
   cpp.cropTop               = pb.croptop();
   cpp.cropBottom            = pb.cropbottom();
   cpp.enabled               = pb.enabled();
   cpp.area                  = pb.area();
}

static void deserialise(RefereeHandDetectorParams &cpp, const offnao::Vision_RefereeHandDetectorParams &pb) {
   cpp.maskTopStartH         = pb.masktopstarth();
   cpp.maskTopStartS         = pb.masktopstarts();
   cpp.maskTopStartV         = pb.masktopstartv();
   cpp.maskTopEndH           = pb.masktopendh();
   cpp.maskTopEndS           = pb.masktopends();
   cpp.maskTopEndV           = pb.masktopendv();
   cpp.maskBottomStartH      = pb.maskbottomstarth();
   cpp.maskBottomStartS      = pb.maskbottomstarts();
   cpp.maskBottomStartV      = pb.maskbottomstartv();
   cpp.maskBottomEndH        = pb.maskbottomendh();
   cpp.maskBottomEndS        = pb.maskbottomends();
   cpp.maskBottomEndV        = pb.maskbottomendv();
}
...
static void deserialise(RefereeHand &cpp, const offnao::Vision_RefereeHand &pb) {
   deserialise(cpp.topImageCoords, pb.topimagecoords());
}

static void deserialise(RefereeHandsVisionInfo &cpp, const offnao::Vision_RefereeHandsVisionInfo &pb) {
   deserialise(cpp.left, pb.left());
   deserialise(cpp.right, pb.right());
}
...
//      ::deserialise(cpp.stateEstimation.robotPos, pb.stateestimation().robotpos());
      ...
      ::deserialise(cpp.vision.redRegions, pb.vision().redregions());
      ::deserialise(cpp.vision.refereeHands, pb.vision().refereehands());
      ::deserialise(cpp.vision.refereeHandDetectorSettings, pb.vision().refereehanddetectorsettings());
      ::deserialise(cpp.vision.cropRegion, pb.vision().cropregion());
      ::deserialise(cpp.vision.refereeHandDetectorParams, pb.vision().refereehanddetectorparams());
   }
