...
@see
https://github.com/UNSWComputing/rUNSWift/tree/main/robot/perception/behaviour/python/wrappers

For info, the following contains the C++ definition of `TOP_IMAGE_ROWS`:
@see
https://github.com/UNSWComputing/rUNSWift/blob/main/robot/perception/vision/VisionDefinitions.hpp
"""
