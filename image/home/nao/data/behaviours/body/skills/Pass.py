...
class Pass(BehaviourTask):
    ...
    def _tick(self, pass_target=None, can_abort=True):
        (
            mode,
            target,
            foot,
            ...
            lineup_distance,
            use_line_up_map,
        ) = self._decide_shoot_parameters(pass_target)
    ...
    def _decide_shoot_parameters(self, pass_target):
